...
Levels = {
    ...
    [3] = {
        { 'v', 'v', 'v',  'v', 'w', 'w',  'w',  'w',  'w',  'w', 'w', 'v', 'v', 'v', },
        { 'v', 'v', 'v',  'w', 'w', 'f',  'f',  'f',  'f',  'w', 'w', 'w', 'v', 'v', },
        { 'v', 'w', 'w',  'w', 'w', 'f',  'G',  'f',  'f',  'w', 'w', 'f', 'w', 'v', },
        { 'v', 'w', 'fP', 'w', 'w', 'f',  'f',  'f',  'f',  'w', 'w', 'f', 'w', 'v', },
        { 'v', 'w', 'f',  'w', 'w', 'v',  'v',  'v',  'v',  'w', 'w', 'f', 'w', 'v', },
        { 'v', 'w', 'f',  'f', 'f', 'fe', 'fe', 'fe', 'fe', 'f', 'f', 'v', 'w', 'v', },
        { 'v', 'w', 'f',  'f', 'f', 'f',  'f',  'f',  'f',  'f', 'f', 'v', 'w', 'v', },
